...
public sealed class FormatCommandHandlerTests
{
    ...
    /// <summary>
    /// Valid C# source marked as auto-generated in its header
    /// </summary>
    private const string AutoGeneratedCsContent = "// <auto-generated />\n" + ValidCsContent;
    ...
    /// <summary>
    /// Verifies that header-marked generated files do not trigger the large-run error for noninteractive input
    /// </summary>
    /// <returns>A task representing the asynchronous test operation</returns>
    [TestMethod]
    public async Task ExecuteAsyncLargeRunHeaderGeneratedFilesSkipNonInteractiveConfirmation()
    {
        var fileSystem = Substitute.For<IFileSystem>();
        var console = new CapturedConsoleOutput();
        ...
        var fileCount = FormatCommandHandler.LargeRunConfirmationThreshold + 1;
        var files = Enumerable.Range(0, fileCount)
                              .Select(index => $"{directoryPath}/Generated{index}.cs")
                              .ToArray();
        ...
        {
            SetupFileContent(fileSystem, filePath, AutoGeneratedCsContent);
        }
        ...
        Assert.Contains(line => line == "Formatted 0 of 0 file(s).", console.StandardOutput);
