...
public class HunkBuilderTests
{
    ...
    public void BuildHunkCountsAreCorrect()
    {
        ...
        var hunk = hunks[0];
        var expectedOriginalCount = hunk.Operations.Count(operation => operation.Kind is EditKind.Equal or EditKind.Delete);
        var expectedFormattedCount = hunk.Operations.Count(operation => operation.Kind is EditKind.Equal or EditKind.Insert);
