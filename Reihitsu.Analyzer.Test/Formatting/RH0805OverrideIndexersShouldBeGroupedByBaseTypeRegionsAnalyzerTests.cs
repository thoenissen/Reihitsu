...
/// <summary>
/// Test methods for <see cref="RH0805OverrideIndexersShouldBeGroupedByBaseTypeRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0805OverrideIndexersShouldBeGroupedByBaseTypeRegionsAnalyzerTests : AnalyzerTestsBase<RH0805OverrideIndexersShouldBeGroupedByBaseTypeRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForOverrideIndexerInGenericRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0805OverrideIndexersShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    public async Task VerifyDiagnosticsForOverrideIndexersFromDifferentBaseTypes()
    {
        ...
        await Verify(testData,
                     Diagnostics(RH0805OverrideIndexersShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId,
    ...
    {
        return string.Format(AnalyzerResources.RH0805MessageFormat, baseTypeName);
    }
