...
/// <summary>
/// Test methods for <see cref="RH0804OverrideEventsShouldBeGroupedByBaseTypeRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0804OverrideEventsShouldBeGroupedByBaseTypeRegionsAnalyzerTests : AnalyzerTestsBase<RH0804OverrideEventsShouldBeGroupedByBaseTypeRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForFieldLikeOverrideEventInGenericRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0804OverrideEventsShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    public async Task VerifyDiagnosticsForOverrideEventsFromDifferentBaseTypes()
    {
        ...
        await Verify(testData,
                     Diagnostics(RH0804OverrideEventsShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId,
    ...
    {
        return string.Format(AnalyzerResources.RH0804MessageFormat, baseTypeName);
    }
