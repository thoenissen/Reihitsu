...
/// <summary>
/// Test methods for <see cref="RH0387ATypesShouldBeOrganizedWithRegionsForMultipleKindsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0387ATypesShouldBeOrganizedWithRegionsForMultipleKindsAnalyzerTests : AnalyzerTestsBase<RH0387ATypesShouldBeOrganizedWithRegionsForMultipleKindsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticWhenClassHasMixedMemberKindsWithoutRegions()
    {
        ...
        await Verify(testData, Diagnostics(RH0387ATypesShouldBeOrganizedWithRegionsForMultipleKindsAnalyzer.DiagnosticId, AnalyzerResources.RH0387AMessageFormat));
    }
