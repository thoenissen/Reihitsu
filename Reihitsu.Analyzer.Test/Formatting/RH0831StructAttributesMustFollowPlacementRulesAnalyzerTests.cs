...
/// <summary>
/// Test methods for <see cref="RH0831StructAttributesMustFollowPlacementRulesAnalyzer"/> and <see cref="RH0831StructAttributesMustFollowPlacementRulesCodeFixProvider"/>
/// </summary>
[TestClass]
public class RH0831StructAttributesMustFollowPlacementRulesAnalyzerTests : AnalyzerTestsBase<RH0831StructAttributesMustFollowPlacementRulesAnalyzer, RH0831StructAttributesMustFollowPlacementRulesCodeFixProvider>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticWithoutCodeFixWhenCommentsArePresent()
    {
        ...
        var actions = await GetCodeFixActionsAsync(codeFixData,
                                                   RH0831StructAttributesMustFollowPlacementRulesAnalyzer.DiagnosticId,
