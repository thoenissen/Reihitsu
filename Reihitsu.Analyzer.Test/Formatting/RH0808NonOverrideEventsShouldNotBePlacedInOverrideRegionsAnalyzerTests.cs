...
/// <summary>
/// Test methods for <see cref="RH0808NonOverrideEventsShouldNotBePlacedInOverrideRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0808NonOverrideEventsShouldNotBePlacedInOverrideRegionsAnalyzerTests : AnalyzerTestsBase<RH0808NonOverrideEventsShouldNotBePlacedInOverrideRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForNonOverrideEventInOverrideRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0808NonOverrideEventsShouldNotBePlacedInOverrideRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    {
        return string.Format(AnalyzerResources.RH0808MessageFormat, regionName);
    }
