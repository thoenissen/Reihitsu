...
/// <summary>
/// Test methods for <see cref="RH0856AccessorAttributeListsMustFollowShapeRulesAnalyzer"/> and <see cref="RH0856AccessorAttributeListsMustFollowShapeRulesCodeFixProvider"/>
/// </summary>
[TestClass]
public class RH0856AccessorAttributeListsMustFollowShapeRulesAnalyzerTests : AnalyzerTestsBase<RH0856AccessorAttributeListsMustFollowShapeRulesAnalyzer, RH0856AccessorAttributeListsMustFollowShapeRulesCodeFixProvider>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticAndCodeFixForMultilineAccessorPolicyViolation()
    {
        ...
        await Verify(testData,
                     fixedData,
                     Diagnostics(RH0856AccessorAttributeListsMustFollowShapeRulesAnalyzer.DiagnosticId, AnalyzerResources.RH0856MessageFormat));
    }
    ...
    public async Task VerifyDiagnosticWithoutCodeFixWhenCommentsArePresent()
    {
        ...
        var actions = await GetCodeFixActionsAsync(codeFixData,
                                                   RH0856AccessorAttributeListsMustFollowShapeRulesAnalyzer.DiagnosticId,
