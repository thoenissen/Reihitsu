...
/// <summary>
/// Test methods for <see cref="RH0809NonOverrideIndexersShouldNotBePlacedInOverrideRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0809NonOverrideIndexersShouldNotBePlacedInOverrideRegionsAnalyzerTests : AnalyzerTestsBase<RH0809NonOverrideIndexersShouldNotBePlacedInOverrideRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForNonOverrideIndexerInOverrideRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0809NonOverrideIndexersShouldNotBePlacedInOverrideRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    {
        return string.Format(AnalyzerResources.RH0809MessageFormat, regionName);
    }
