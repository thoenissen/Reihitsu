...
/// <summary>
/// Test methods for <see cref="RH0803OverridePropertiesShouldBeGroupedByBaseTypeRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0803OverridePropertiesShouldBeGroupedByBaseTypeRegionsAnalyzerTests : AnalyzerTestsBase<RH0803OverridePropertiesShouldBeGroupedByBaseTypeRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForOverridePropertyOutsideRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0803OverridePropertiesShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    public async Task VerifyDiagnosticsForOverridePropertiesFromDifferentBaseTypes()
    {
        ...
        await Verify(testData,
                     Diagnostics(RH0803OverridePropertiesShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId,
    ...
    {
        return string.Format(AnalyzerResources.RH0803MessageFormat, baseTypeName);
    }
