...
/// <summary>
/// Test methods for <see cref="RH0849DelegateAttributesMustFollowPlacementRulesAnalyzer"/> and <see cref="RH0849DelegateAttributesMustFollowPlacementRulesCodeFixProvider"/>
/// </summary>
[TestClass]
public class RH0849DelegateAttributesMustFollowPlacementRulesAnalyzerTests : AnalyzerTestsBase<RH0849DelegateAttributesMustFollowPlacementRulesAnalyzer, RH0849DelegateAttributesMustFollowPlacementRulesCodeFixProvider>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticWithoutCodeFixWhenCommentsArePresent()
    {
        ...
        var actions = await GetCodeFixActionsAsync(codeFixData,
                                                   RH0849DelegateAttributesMustFollowPlacementRulesAnalyzer.DiagnosticId,
