...
/// <summary>
/// Test methods for <see cref="RH0802OverrideMethodsShouldBeGroupedByBaseTypeRegionsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0802OverrideMethodsShouldBeGroupedByBaseTypeRegionsAnalyzerTests : AnalyzerTestsBase<RH0802OverrideMethodsShouldBeGroupedByBaseTypeRegionsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticForOverrideMethodInGenericRegion()
    {
        ...
        await Verify(testData, Diagnostics(RH0802OverrideMethodsShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId, CreateMessage("BaseProcessor")));
    }
    ...
    public async Task VerifyDiagnosticsForOverrideMethodsFromDifferentBaseTypes()
    {
        ...
        await Verify(testData,
                     Diagnostics(RH0802OverrideMethodsShouldBeGroupedByBaseTypeRegionsAnalyzer.DiagnosticId,
    ...
    {
        return string.Format(AnalyzerResources.RH0802MessageFormat, baseTypeName);
    }
