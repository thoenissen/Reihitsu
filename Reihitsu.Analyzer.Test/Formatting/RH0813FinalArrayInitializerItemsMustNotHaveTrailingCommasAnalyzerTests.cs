...
/// <summary>
/// Test methods for <see cref="RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasAnalyzer"/> and <see cref="RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasCodeFixProvider"/>
/// </summary>
[TestClass]
public class RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasAnalyzerTests : AnalyzerTestsBase<RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasAnalyzer, RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasCodeFixProvider>
{
    #region Tests
    ...
    public async Task VerifyTrailingCommaOnFinalExplicitArrayItemIsDetectedAndFixed()
    {
        ...
        await Verify(testData, fixedData, Diagnostics(RH0813FinalArrayInitializerItemsMustNotHaveTrailingCommasAnalyzer.DiagnosticId, AnalyzerResources.RH0813MessageFormat));
    }
