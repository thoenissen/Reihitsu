...
/// <summary>
/// Test methods for <see cref="RH0855AccessorAttributesMustFollowPlacementRulesAnalyzer"/> and <see cref="RH0855AccessorAttributesMustFollowPlacementRulesCodeFixProvider"/>
/// </summary>
[TestClass]
public class RH0855AccessorAttributesMustFollowPlacementRulesAnalyzerTests : AnalyzerTestsBase<RH0855AccessorAttributesMustFollowPlacementRulesAnalyzer, RH0855AccessorAttributesMustFollowPlacementRulesCodeFixProvider>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticWithoutCodeFixWhenCommentsArePresent()
    {
        ...
        var actions = await GetCodeFixActionsAsync(codeFixData,
                                                   RH0855AccessorAttributesMustFollowPlacementRulesAnalyzer.DiagnosticId,
