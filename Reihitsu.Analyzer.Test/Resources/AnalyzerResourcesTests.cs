...
/// <summary>
/// Tests for <see cref="AnalyzerResources"/>
/// </summary>
[TestClass]
public class AnalyzerResourcesTests
{
    #region Tests
    ...
    {
        var properties = typeof(AnalyzerResources).GetProperties(BindingFlags.NonPublic | BindingFlags.Static);
