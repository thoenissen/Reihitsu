...
/// <summary>
/// Tests for <see cref="RH8016PrivateDelegatesMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8016PrivateDelegatesMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8016PrivateDelegatesMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForPrivateDelegateWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8016PrivateDelegatesMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8016MessageFormat));
    }
    ...
    /// Non-private delegates are covered by RH8015, not by this analyzer.
