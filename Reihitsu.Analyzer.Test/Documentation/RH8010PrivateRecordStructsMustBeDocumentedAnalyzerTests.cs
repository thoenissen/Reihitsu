...
/// <summary>
/// Tests for <see cref="RH8010PrivateRecordStructsMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8010PrivateRecordStructsMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8010PrivateRecordStructsMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForPrivateRecordStructWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8010PrivateRecordStructsMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8010MessageFormat));
    }
    ...
    /// <summary>
    /// Verifies no diagnostic is reported for an undocumented non-private nested record struct, which is handled by RH8009.
