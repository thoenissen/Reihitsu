...
/// <summary>
/// Tests for <see cref="RH8007NonPrivateRecordsMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8007NonPrivateRecordsMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8007NonPrivateRecordsMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForRecordWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8007NonPrivateRecordsMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8007MessageFormat));
    }
    ...
    /// Pure private declarations are covered by RH8008, not by this analyzer
    /// </summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation</returns>
    [TestMethod]
