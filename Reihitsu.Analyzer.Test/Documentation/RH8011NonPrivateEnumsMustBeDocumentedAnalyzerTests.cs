...
/// <summary>
/// Tests for <see cref="RH8011NonPrivateEnumsMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8011NonPrivateEnumsMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8011NonPrivateEnumsMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForEnumWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8011NonPrivateEnumsMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8011MessageFormat));
    }
    ...
    /// Pure private declarations are covered by RH8012, not by this analyzer
    /// </summary>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation</returns>
    [TestMethod]
