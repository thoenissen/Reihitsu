...
/// <summary>
/// Tests for <see cref="RH8015NonPrivateDelegatesMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8015NonPrivateDelegatesMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8015NonPrivateDelegatesMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForDelegateWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8015NonPrivateDelegatesMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8015MessageFormat));
    }
    ...
    /// Private delegates are covered by RH8016, not by this analyzer.
