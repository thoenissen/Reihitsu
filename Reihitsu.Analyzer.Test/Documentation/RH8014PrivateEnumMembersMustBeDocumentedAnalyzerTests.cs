...
/// <summary>
/// Tests for <see cref="RH8014PrivateEnumMembersMustBeDocumentedAnalyzer"/>
/// </summary>
[TestClass]
public class RH8014PrivateEnumMembersMustBeDocumentedAnalyzerTests : AnalyzerTestsBase<RH8014PrivateEnumMembersMustBeDocumentedAnalyzer>
{
    ...
    public async Task VerifyDiagnosticForEnumMemberInPrivateEnumWithoutDocumentation()
    {
        ...
        await Verify(source, Diagnostics(RH8014PrivateEnumMembersMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8014MessageFormat));
    }
    ...
    public async Task VerifyDiagnosticForMultipleUndocumentedMembersInPrivateEnum()
    {
        ...
        await Verify(source, Diagnostics(RH8014PrivateEnumMembersMustBeDocumentedAnalyzer.DiagnosticId, AnalyzerResources.RH8014MessageFormat, 3));
    }
    ...
    /// Members of non-private enums are covered by RH8013, not by this analyzer.
