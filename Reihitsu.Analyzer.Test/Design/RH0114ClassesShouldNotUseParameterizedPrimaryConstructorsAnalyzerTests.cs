...
/// <summary>
/// Test methods for <see cref="RH0114ClassesShouldNotUseParameterizedPrimaryConstructorsAnalyzer"/>
/// </summary>
[TestClass]
public class RH0114ClassesShouldNotUseParameterizedPrimaryConstructorsAnalyzerTests : AnalyzerTestsBase<RH0114ClassesShouldNotUseParameterizedPrimaryConstructorsAnalyzer>
{
    #region Tests
    ...
    public async Task VerifyDiagnosticsForParameterizedClassPrimaryConstructors()
    {
        ...
        await Verify(source, Diagnostics(RH0114ClassesShouldNotUseParameterizedPrimaryConstructorsAnalyzer.DiagnosticId, AnalyzerResources.RH0114MessageFormat, 2));
    }
