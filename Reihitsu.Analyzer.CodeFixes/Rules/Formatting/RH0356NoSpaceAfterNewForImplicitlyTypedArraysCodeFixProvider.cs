...
/// <summary>
/// Code fix provider for <see cref="RH0356NoSpaceAfterNewForImplicitlyTypedArraysAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0356NoSpaceAfterNewForImplicitlyTypedArraysCodeFixProvider))]
public class RH0356NoSpaceAfterNewForImplicitlyTypedArraysCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0356NoSpaceAfterNewForImplicitlyTypedArraysAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0356Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0356NoSpaceAfterNewForImplicitlyTypedArraysCodeFixProvider)),
                                    diagnostic);
        }
