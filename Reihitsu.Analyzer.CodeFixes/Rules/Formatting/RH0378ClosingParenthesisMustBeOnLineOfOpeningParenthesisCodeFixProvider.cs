...
/// <summary>
/// Code fix provider for <see cref="RH0378ClosingParenthesisMustBeOnLineOfOpeningParenthesisAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0378ClosingParenthesisMustBeOnLineOfOpeningParenthesisCodeFixProvider))]
public class RH0378ClosingParenthesisMustBeOnLineOfOpeningParenthesisCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0378ClosingParenthesisMustBeOnLineOfOpeningParenthesisAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0378Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0378ClosingParenthesisMustBeOnLineOfOpeningParenthesisCodeFixProvider)),
                                    diagnostic);
        }
