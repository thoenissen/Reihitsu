...
public class RH0365CodeMustNotContainMultipleBlankLinesInARowCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0365CodeMustNotContainMultipleBlankLinesInARowAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0365Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0365CodeMustNotContainMultipleBlankLinesInARowCodeFixProvider)),
                                    diagnostic);
        }
