...
/// <summary>
/// Providing fixes for <see cref="RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyCodeFixProvider))]
public class RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyAnalyzer.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (root != null)
        {
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                {
                    context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0821Title,
                                                              c => ApplyCodeFixAsync(context.Document, formatTarget, c),
                                                              nameof(RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyCodeFixProvider)),
                                            diagnostic);
                }
            }
        }
