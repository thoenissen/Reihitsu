...
/// <summary>
/// Providing fixes for <see cref="RH0801SwitchExpressionBracesShouldBeAnchoredAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0801SwitchExpressionBracesShouldBeAnchoredCodeFixProvider))]
public class RH0801SwitchExpressionBracesShouldBeAnchoredCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0801SwitchExpressionBracesShouldBeAnchoredAnalyzer.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (root != null)
        {
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                {
                    context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0801Title,
                                                              c => ApplyCodeFixAsync(context.Document, formatTarget, c),
                                                              nameof(RH0801SwitchExpressionBracesShouldBeAnchoredCodeFixProvider)),
                                            diagnostic);
                }
            }
        }
