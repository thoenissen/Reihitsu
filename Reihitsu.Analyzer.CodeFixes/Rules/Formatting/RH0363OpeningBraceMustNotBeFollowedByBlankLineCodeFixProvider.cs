...
/// <summary>
/// Code fix provider for <see cref="RH0363OpeningBraceMustNotBeFollowedByBlankLineAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0363OpeningBraceMustNotBeFollowedByBlankLineCodeFixProvider))]
public class RH0363OpeningBraceMustNotBeFollowedByBlankLineCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0363OpeningBraceMustNotBeFollowedByBlankLineAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0363Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0363OpeningBraceMustNotBeFollowedByBlankLineCodeFixProvider)),
                                    diagnostic);
        }
