...
/// <summary>
/// Code fix provider for <see cref="RH0380ParameterListMustFollowDeclarationAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0380ParameterListMustFollowDeclarationCodeFixProvider))]
public class RH0380ParameterListMustFollowDeclarationCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0380ParameterListMustFollowDeclarationAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0380Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0380ParameterListMustFollowDeclarationCodeFixProvider)),
                                    diagnostic);
        }
