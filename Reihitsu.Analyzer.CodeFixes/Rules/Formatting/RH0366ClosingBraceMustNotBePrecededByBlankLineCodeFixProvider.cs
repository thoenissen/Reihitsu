...
/// <summary>
/// Code fix provider for <see cref="RH0366ClosingBraceMustNotBePrecededByBlankLineAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0366ClosingBraceMustNotBePrecededByBlankLineCodeFixProvider))]
public class RH0366ClosingBraceMustNotBePrecededByBlankLineCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0366ClosingBraceMustNotBePrecededByBlankLineAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0366Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0366ClosingBraceMustNotBePrecededByBlankLineCodeFixProvider)),
                                    diagnostic);
        }
