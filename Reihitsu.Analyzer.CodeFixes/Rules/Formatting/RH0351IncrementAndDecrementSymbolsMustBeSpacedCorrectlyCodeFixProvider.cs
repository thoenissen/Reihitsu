...
public class RH0351IncrementAndDecrementSymbolsMustBeSpacedCorrectlyCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0351IncrementAndDecrementSymbolsMustBeSpacedCorrectlyAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0351Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0351IncrementAndDecrementSymbolsMustBeSpacedCorrectlyCodeFixProvider)),
                                    diagnostic);
        }
