...
public class RH0339OperatorKeywordMustBeFollowedBySpaceCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0339OperatorKeywordMustBeFollowedBySpaceAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0339Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0339OperatorKeywordMustBeFollowedBySpaceCodeFixProvider)),
                                    diagnostic);
        }
