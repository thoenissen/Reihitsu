...
/// <summary>
/// Providing fixes for <see cref="RH0398WrappedFluentCallsShouldKeepFirstCallOnOriginalLineAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0398WrappedFluentCallsShouldKeepFirstCallOnOriginalLineCodeFixProvider))]
public class RH0398WrappedFluentCallsShouldKeepFirstCallOnOriginalLineCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0398WrappedFluentCallsShouldKeepFirstCallOnOriginalLineAnalyzer.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (root != null)
        {
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                if (chainRoot != null)
                {
                    context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0398Title,
                                                              cancellationToken => ApplyCodeFixAsync(context.Document, chainRoot, cancellationToken),
                                                              nameof(RH0398WrappedFluentCallsShouldKeepFirstCallOnOriginalLineCodeFixProvider)),
                                            diagnostic);
                }
            }
        }
