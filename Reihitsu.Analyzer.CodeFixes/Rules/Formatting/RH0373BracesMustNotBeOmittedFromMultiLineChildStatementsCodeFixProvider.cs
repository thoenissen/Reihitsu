...
public class RH0373BracesMustNotBeOmittedFromMultiLineChildStatementsCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    {
        return await WrapStatementWithBracesAsync(document, diagnosticSpan, cancellationToken).ConfigureAwait(false);
    }
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0373BracesMustNotBeOmittedFromMultiLineChildStatementsAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0373Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0373BracesMustNotBeOmittedFromMultiLineChildStatementsCodeFixProvider)),
                                    diagnostic);
        }
