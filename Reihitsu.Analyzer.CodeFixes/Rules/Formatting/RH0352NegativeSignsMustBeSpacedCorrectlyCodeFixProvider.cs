...
/// <summary>
/// Code fix provider for <see cref="RH0352NegativeSignsMustBeSpacedCorrectlyAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0352NegativeSignsMustBeSpacedCorrectlyCodeFixProvider))]
public class RH0352NegativeSignsMustBeSpacedCorrectlyCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0352NegativeSignsMustBeSpacedCorrectlyAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0352Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0352NegativeSignsMustBeSpacedCorrectlyCodeFixProvider)),
                                    diagnostic);
        }
