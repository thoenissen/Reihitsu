...
/// <summary>
/// Code fix provider for <see cref="RH0338PreprocessorKeywordsMustNotBePrecededBySpaceAnalyzer"/>.
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH0338PreprocessorKeywordsMustNotBePrecededBySpaceCodeFixProvider))]
public class RH0338PreprocessorKeywordsMustNotBePrecededBySpaceCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH0338PreprocessorKeywordsMustNotBePrecededBySpaceAnalyzer.DiagnosticId];
    ...
    public sealed override Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        {
            context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH0338Title,
                                                      token => ApplyCodeFixAsync(context.Document, diagnostic.Location.SourceSpan, token),
                                                      nameof(RH0338PreprocessorKeywordsMustNotBePrecededBySpaceCodeFixProvider)),
                                    diagnostic);
        }
