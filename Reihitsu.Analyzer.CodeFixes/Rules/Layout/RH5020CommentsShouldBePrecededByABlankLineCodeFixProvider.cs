...
/// <summary>
/// Code fix provider for <see cref="RH5020CommentsShouldBePrecededByABlankLineAnalyzer"/>
/// </summary>
[Shared]
...
public class RH5020CommentsShouldBePrecededByABlankLineCodeFixProvider : CodeFixProvider
{
    ...
    /// <summary>
    /// Applies the code fix by inserting a blank line before the reported comment
    /// </summary>
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH5020CommentsShouldBePrecededByABlankLineAnalyzer.DiagnosticId];
