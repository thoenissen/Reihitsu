...
/// <summary>
/// Code fix provider for <see cref="RH5514MethodAttributeListsMustFollowShapeRulesAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH5514MethodAttributeListsMustFollowShapeRulesCodeFixProvider))]
public class RH5514MethodAttributeListsMustFollowShapeRulesCodeFixProvider : TargetAttributeListShapeCodeFixProviderBase
{
    #region TargetAttributeListShapeCodeFixProviderBase

    /// <inheritdoc/>
    protected override string DiagnosticId => RH5514MethodAttributeListsMustFollowShapeRulesAnalyzer.DiagnosticId;
    ...
    /// <inheritdoc/>
    protected override string CodeFixTitle => CodeFixResources.RH5514Title;
