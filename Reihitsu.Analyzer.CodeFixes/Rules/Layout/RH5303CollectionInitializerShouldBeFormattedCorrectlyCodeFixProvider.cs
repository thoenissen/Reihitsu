...
/// <summary>
/// Providing fixes for <see cref="RH5303CollectionInitializerShouldBeFormattedCorrectlyAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH5303CollectionInitializerShouldBeFormattedCorrectlyCodeFixProvider))]
public class RH5303CollectionInitializerShouldBeFormattedCorrectlyCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH5303CollectionInitializerShouldBeFormattedCorrectlyAnalyzer.DiagnosticId];
