...
/// <summary>
/// Code fix provider for <see cref="RH3104DoNotUseDefaultValueTypeConstructorAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH3104DoNotUseDefaultValueTypeConstructorCodeFixProvider))]
public class RH3104DoNotUseDefaultValueTypeConstructorCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH3104DoNotUseDefaultValueTypeConstructorAnalyzer.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (root != null)
        {
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                {
                    context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH3104Title,
                                                              token => ApplyCodeFixAsync(context.Document, expressionSyntax, token),
                                                              nameof(RH3104DoNotUseDefaultValueTypeConstructorCodeFixProvider)),
                                            diagnostic);
                }
            }
        }
