...
/// <summary>
/// Code fix provider for <see cref="RH3203ExpressionStyleConstructorsShouldNotBeUsedAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH3203ExpressionStyleConstructorsShouldNotBeUsedCodeFixProvider))]
public class RH3203ExpressionStyleConstructorsShouldNotBeUsedCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH3203ExpressionStyleConstructorsShouldNotBeUsedAnalyzer.DiagnosticId];
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            if (root.FindNode(diagnostic.Location.SourceSpan) is ConstructorDeclarationSyntax constructorDeclaration)
            {
                context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH3203Title,
                                                          ...
                                                          nameof(RH3203ExpressionStyleConstructorsShouldNotBeUsedCodeFixProvider)),
                                        diagnostic);
            }
        }
    }
