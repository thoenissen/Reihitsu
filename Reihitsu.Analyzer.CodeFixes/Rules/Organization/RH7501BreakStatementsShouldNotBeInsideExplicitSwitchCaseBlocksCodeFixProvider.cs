...
/// <summary>
/// Code fix provider for <see cref="RH7501BreakStatementsShouldNotBeInsideExplicitSwitchCaseBlocksAnalyzer"/>
/// </summary>
[Shared]
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RH7501BreakStatementsShouldNotBeInsideExplicitSwitchCaseBlocksCodeFixProvider))]
public class RH7501BreakStatementsShouldNotBeInsideExplicitSwitchCaseBlocksCodeFixProvider : CodeFixProvider
{
    #region Methods
    ...
    /// <inheritdoc/>
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RH7501BreakStatementsShouldNotBeInsideExplicitSwitchCaseBlocksAnalyzer.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        if (root != null)
        {
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                {
                    context.RegisterCodeFix(CodeAction.Create(CodeFixResources.RH7501Title,
                                                              token => ApplyCodeFixAsync(context.Document, breakStatement, token),
                                                              nameof(RH7501BreakStatementsShouldNotBeInsideExplicitSwitchCaseBlocksCodeFixProvider)),
                                            diagnostic);
                }
            }
        }
