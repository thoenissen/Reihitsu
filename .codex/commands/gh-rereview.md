...
6. Prefer static tracing. If a targeted run changes a classification, confirm the preinstalled SDK with `scripts/prepare.sh --no-install` and run only the filtered test or formatter double-run needed. Never install an SDK or modify `PATH`.
