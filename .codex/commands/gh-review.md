...
Invoke the `gh-review` skill and follow it exactly. It supports Linux cloud and local Windows environments with no assumed `gh` CLI — all GitHub access uses the available GitHub MCP tools:
