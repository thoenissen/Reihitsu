...
6. Push and open a **draft** PR with the available GitHub MCP pull-request tool, using `.github/PULL_REQUEST_TEMPLATE.md` with `Closes #$ARGUMENTS`.
7. Post the PR URL back on the issue with the available GitHub MCP issue-comment tool.
