...
2. Classify every item as fix, skip, or needs decision. Ask the user before acting on ambiguous, contested, architecturally significant, public-API-changing, or dependency-changing feedback.
