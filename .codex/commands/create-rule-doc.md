...
Write or update a Reihitsu analyzer rule markdown file under `documentation/rules/RH####.md`.
...
- Roslyn API choices, analyzer registration details, syntax kinds, or semantic model discussion
- Check logic algorithms, code-fix internals, or edge-case implementation notes
- Migration notes from StyleCop

## Repository-specific guidance

- Match the format used by existing docs such as `documentation/rules/RH3001.md`, `documentation/rules/RH2004.md`, `documentation/rules/RH3202.md`.
