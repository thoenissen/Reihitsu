...
public class RH1003UseStringInterpolationInsteadOfStringConcatenationAnalyzer : DiagnosticAnalyzerBase<RH1003UseStringInterpolationInsteadOfStringConcatenationAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH1003";
    ...
    /// Constructor
    /// </summary>
    public RH1003UseStringInterpolationInsteadOfStringConcatenationAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Performance, nameof(AnalyzerResources.RH1003Title), nameof(AnalyzerResources.RH1003MessageFormat))
    {
    }
