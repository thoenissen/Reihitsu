...
public class RH7105DeclarationKeywordsMustFollowOrderAnalyzer : DiagnosticAnalyzerBase<RH7105DeclarationKeywordsMustFollowOrderAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH7105";
    ...
    /// Constructor
    /// </summary>
    public RH7105DeclarationKeywordsMustFollowOrderAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Organization, nameof(AnalyzerResources.RH7105Title), nameof(AnalyzerResources.RH7105MessageFormat))
    {
    }
    ...
    private void OnDeclaration(SyntaxNodeAnalysisContext context)
    {
        ...
        if (ModifierOrderingUtilities.TryGetRh7105Violation(modifiers, out var diagnosticToken))
        {
