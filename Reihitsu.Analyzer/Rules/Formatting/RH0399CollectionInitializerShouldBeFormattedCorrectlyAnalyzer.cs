...
/// <summary>
/// RH0399: The collection initializer should be formatted correctly
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public class RH0399CollectionInitializerShouldBeFormattedCorrectlyAnalyzer : DiagnosticAnalyzerBase<RH0399CollectionInitializerShouldBeFormattedCorrectlyAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0399";
    ...
    /// Constructor
    /// </summary>
    public RH0399CollectionInitializerShouldBeFormattedCorrectlyAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Formatting, nameof(AnalyzerResources.RH0399Title), nameof(AnalyzerResources.RH0399MessageFormat))
    {
    }
