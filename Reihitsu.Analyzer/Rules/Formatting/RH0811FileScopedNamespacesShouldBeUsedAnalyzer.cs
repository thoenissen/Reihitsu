...
public class RH0811FileScopedNamespacesShouldBeUsedAnalyzer : DiagnosticAnalyzerBase<RH0811FileScopedNamespacesShouldBeUsedAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0811";
    ...
    /// Constructor
    /// </summary>
    public RH0811FileScopedNamespacesShouldBeUsedAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Formatting, nameof(AnalyzerResources.RH0811Title), nameof(AnalyzerResources.RH0811MessageFormat))
    {
    }
