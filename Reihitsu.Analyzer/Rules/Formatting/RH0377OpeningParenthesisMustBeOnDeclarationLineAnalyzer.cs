...
public class RH0377OpeningParenthesisMustBeOnDeclarationLineAnalyzer : DiagnosticAnalyzerBase<RH0377OpeningParenthesisMustBeOnDeclarationLineAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0377";
    ...
    /// Constructor
    /// </summary>
    public RH0377OpeningParenthesisMustBeOnDeclarationLineAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Formatting, nameof(AnalyzerResources.RH0377Title), nameof(AnalyzerResources.RH0377MessageFormat))
    {
    }
