...
/// <summary>
/// RH0823: List patterns should be formatted correctly
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public class RH0823ListPatternsShouldBeFormattedCorrectlyAnalyzer : DiagnosticAnalyzerBase<RH0823ListPatternsShouldBeFormattedCorrectlyAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0823";
    ...
    /// Constructor
    /// </summary>
    public RH0823ListPatternsShouldBeFormattedCorrectlyAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Formatting, nameof(AnalyzerResources.RH0823Title), nameof(AnalyzerResources.RH0823MessageFormat))
    {
    }
