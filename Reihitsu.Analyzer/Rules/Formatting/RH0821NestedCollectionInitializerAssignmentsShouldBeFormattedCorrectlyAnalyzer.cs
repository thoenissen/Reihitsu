...
/// <summary>
/// RH0821: Nested collection initializer assignments should be formatted correctly
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public class RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyAnalyzer : DiagnosticAnalyzerBase<RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0821";
    ...
    /// Constructor
    /// </summary>
    public RH0821NestedCollectionInitializerAssignmentsShouldBeFormattedCorrectlyAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Formatting, nameof(AnalyzerResources.RH0821Title), nameof(AnalyzerResources.RH0821MessageFormat))
    {
    }
