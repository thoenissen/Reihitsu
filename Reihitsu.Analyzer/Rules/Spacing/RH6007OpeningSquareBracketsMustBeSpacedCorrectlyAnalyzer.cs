...
public class RH6007OpeningSquareBracketsMustBeSpacedCorrectlyAnalyzer : DiagnosticAnalyzerBase<RH6007OpeningSquareBracketsMustBeSpacedCorrectlyAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH6007";
    ...
    /// Constructor
    /// </summary>
    public RH6007OpeningSquareBracketsMustBeSpacedCorrectlyAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Spacing, nameof(AnalyzerResources.RH6007Title), nameof(AnalyzerResources.RH6007MessageFormat))
    {
    }
