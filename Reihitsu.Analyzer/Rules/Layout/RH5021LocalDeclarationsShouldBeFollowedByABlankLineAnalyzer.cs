...
public class RH5021LocalDeclarationsShouldBeFollowedByABlankLineAnalyzer : StatementShouldBePrecededByABlankLineAnalyzerBase<ExpressionStatementSyntax, RH5021LocalDeclarationsShouldBeFollowedByABlankLineAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH5021";
    ...
    /// Constructor
    /// </summary>
    public RH5021LocalDeclarationsShouldBeFollowedByABlankLineAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Layout, nameof(AnalyzerResources.RH5021Title), nameof(AnalyzerResources.RH5021MessageFormat), SyntaxKind.ExpressionStatement)
    {
    }
