...
public class RH5302LogicalExpressionsShouldBeFormattedCorrectlyAnalyzer : DiagnosticAnalyzerBase<RH5302LogicalExpressionsShouldBeFormattedCorrectlyAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH5302";
    ...
    /// Constructor
    /// </summary>
    public RH5302LogicalExpressionsShouldBeFormattedCorrectlyAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Layout, nameof(AnalyzerResources.RH5302Title), nameof(AnalyzerResources.RH5302MessageFormat))
    {
    }
