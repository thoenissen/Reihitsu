...
public class RH5204IndentationMustUseFourSpacesPerScopeLevelAnalyzer : DiagnosticAnalyzerBase
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH5204";
    ...
    /// Constructor
    /// </summary>
    public RH5204IndentationMustUseFourSpacesPerScopeLevelAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Layout, nameof(AnalyzerResources.RH5204Title), nameof(AnalyzerResources.RH5204MessageFormat))
    {
    }
    ...
    /// author wrote it, matching the formatter's <c>LayoutComputer.SetDirectiveIndentation</c>: the code
