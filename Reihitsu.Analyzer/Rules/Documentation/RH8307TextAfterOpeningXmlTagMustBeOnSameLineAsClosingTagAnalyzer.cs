...
public class RH8307TextAfterOpeningXmlTagMustBeOnSameLineAsClosingTagAnalyzer : DiagnosticAnalyzerBase<RH8307TextAfterOpeningXmlTagMustBeOnSameLineAsClosingTagAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH8307";
    ...
    /// Constructor
    /// </summary>
    public RH8307TextAfterOpeningXmlTagMustBeOnSameLineAsClosingTagAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Documentation, nameof(AnalyzerResources.RH8307Title), nameof(AnalyzerResources.RH8307MessageFormat))
    {
    }
