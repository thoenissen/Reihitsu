...
public class RH8107VoidReturnValueMustNotBeDocumentedAnalyzer : DiagnosticAnalyzerBase<RH8107VoidReturnValueMustNotBeDocumentedAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH8107";
    ...
    /// Constructor
    /// </summary>
    public RH8107VoidReturnValueMustNotBeDocumentedAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Documentation, nameof(AnalyzerResources.RH8107Title), nameof(AnalyzerResources.RH8107MessageFormat))
    {
    }
