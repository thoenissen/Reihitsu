...
public class RH0455ExtensionDeclarationTypeParametersMustBeDocumentedAnalyzer : DiagnosticAnalyzerBase<RH0455ExtensionDeclarationTypeParametersMustBeDocumentedAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH0455";
    ...
    /// Constructor
    /// </summary>
    public RH0455ExtensionDeclarationTypeParametersMustBeDocumentedAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Documentation, nameof(AnalyzerResources.RH0455Title), nameof(AnalyzerResources.RH0455MessageFormat))
    {
    }
