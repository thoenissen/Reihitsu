...
public class RH8032ExtensionDeclarationParametersMustBeDocumentedAnalyzer : DiagnosticAnalyzerBase<RH8032ExtensionDeclarationParametersMustBeDocumentedAnalyzer>
{
    #region Constants
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH8032";
    ...
    /// Constructor
    /// </summary>
    public RH8032ExtensionDeclarationParametersMustBeDocumentedAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Documentation, nameof(AnalyzerResources.RH8032Title), nameof(AnalyzerResources.RH8032MessageFormat))
    {
    }
