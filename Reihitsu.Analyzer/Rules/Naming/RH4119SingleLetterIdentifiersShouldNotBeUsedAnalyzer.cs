...
public class RH4119SingleLetterIdentifiersShouldNotBeUsedAnalyzer : DiagnosticAnalyzerBase<RH4119SingleLetterIdentifiersShouldNotBeUsedAnalyzer>
{
    ...
    /// Diagnostic ID
    /// </summary>
    public const string DiagnosticId = "RH4119";
    ...
    /// Constructor
    /// </summary>
    public RH4119SingleLetterIdentifiersShouldNotBeUsedAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Naming, nameof(AnalyzerResources.RH4119Title), nameof(AnalyzerResources.RH4119MessageFormat))
    {
    }
