...
/// <summary>
/// RH0213: Protected field names should be in camelCase
/// </summary>
public class RH0213ProtectedFieldCasingAnalyzer : CasingAnalyzerBase<RH0213ProtectedFieldCasingAnalyzer>
{
    ...
    public RH0213ProtectedFieldCasingAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Naming, nameof(AnalyzerResources.RH0213Title), nameof(AnalyzerResources.RH0213MessageFormat), SyntaxKind.FieldDeclaration, CasingUtilities.IsCamelCase)
    {
    }
