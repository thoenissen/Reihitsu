...
/// <summary>
/// RH0212: Method parameter names should be in camelCase
/// </summary>
public class RH0212PrivateFieldCasingAnalyzer : CasingAnalyzerBase<RH0212PrivateFieldCasingAnalyzer>
{
    ...
    public RH0212PrivateFieldCasingAnalyzer()
        : base(DiagnosticId, DiagnosticCategory.Naming, nameof(AnalyzerResources.RH0212Title), nameof(AnalyzerResources.RH0212MessageFormat), SyntaxKind.FieldDeclaration, CasingUtilities.IsCamelCase)
    {
    }
