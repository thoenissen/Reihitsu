...
/// <summary>
/// Shared base for interface-implementation region analyzers
/// </summary>
/// <typeparam name="TAnalyzer">Concrete analyzer type</typeparam>
public abstract class InterfaceMembersShouldBeGroupedByInterfaceRegionsAnalyzerBase<TAnalyzer> : DiagnosticAnalyzerBase<TAnalyzer>
    where TAnalyzer : DiagnosticAnalyzer
{
    ...
    private protected InterfaceMembersShouldBeGroupedByInterfaceRegionsAnalyzerBase(string diagnosticId, string titleResourceName, string messageFormatResourceName)
