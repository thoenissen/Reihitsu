...
Try the formatter in your browser at **[thoenissen.github.io/Reihitsu](https://thoenissen.github.io/Reihitsu/)** — no install required, and it always runs the formatter from the latest commit on `main`.
