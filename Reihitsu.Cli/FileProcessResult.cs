...
internal readonly record struct FileProcessResult(int ChangedFileCount, int SkippedSyntaxErrorCount, int SkippedEncodingCount, int SkippedGeneratedCount, int ErrorFileCount)
{
    ...
    /// </summary>
    public static readonly FileProcessResult NoChange = new(0, 0, 0, 0, 0);

    /// <summary>
    /// The processed file changed successfully
    /// </summary>
    public static readonly FileProcessResult Changed = new(1, 0, 0, 0, 0);

    /// <summary>
    /// The processed file was skipped due to syntax errors
    /// </summary>
    public static readonly FileProcessResult SkippedSyntaxError = new(0, 1, 0, 0, 0);

    /// <summary>
    /// The processed file was skipped because it could not be decoded using its detected encoding
    /// </summary>
    public static readonly FileProcessResult SkippedEncoding = new(0, 0, 1, 0, 0);

    /// <summary>
    /// The processed file was skipped because it is marked as generated source
    /// </summary>
    public static readonly FileProcessResult SkippedGenerated = new(0, 0, 0, 1, 0);

    /// <summary>
    /// The processed file encountered an error
    /// </summary>
    public static readonly FileProcessResult Error = new(0, 0, 0, 0, 1);
