...
/// </summary>
internal readonly record struct FileProcessResult(int ChangedFileCount, int SkippedSyntaxErrorCount, int SkippedEncodingCount, int ErrorFileCount)
{
    #region Constants
    ...
    /// </summary>
    public static readonly FileProcessResult NoChange = new(0, 0, 0, 0);

    /// <summary>
    /// The processed file changed successfully
    /// </summary>
    public static readonly FileProcessResult Changed = new(1, 0, 0, 0);
    ...
    /// </summary>
    public static readonly FileProcessResult Error = new(0, 0, 0, 1);
