...
internal static class AttributeTargetFormattingShared
{
    ...
    /// <summary>
    /// Resolves the expected placement mode for an attribute list based on its target
    /// </summary>
    ...
    /// <summary>
    /// Resolves the expected list-shape mode for an attribute list based on its target
    /// </summary>
    /// <param name="attributeList">Attribute list</param>
