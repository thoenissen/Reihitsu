...
- [ ] Final chat report states the scope classification with its reason, the contract gate result, official attempts and reviewer process starts separately, scope growth across repair cycles, and whether the budget was exhausted
